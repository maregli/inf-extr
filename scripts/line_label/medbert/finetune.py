...
def parse_args():
    ...
    parser.add_argument("--truncation_size", type=int, default=512, help="Truncation Size of the input text. Defaults to 512")
...
def main():
    ...
    # Prepare Data
    encoded_dataset = prepare_line_label_data(df, tokenizer, truncation_size=512)
